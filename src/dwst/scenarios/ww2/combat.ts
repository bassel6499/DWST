...
import { calculateCommandAndManeuver, calculateEffectiveness, calculateEffects, determineTacticalOutcome, resolveAttrition, type WW2AttritionResult, type WW2CombatEffects, type WW2EffectivenessFactors } from './combatResolution';
...
/**
 * Public WW2 resolver. The resolver is intentionally only an orchestration
 * boundary; the mathematical stages live in focused modules so each stage
 * can be inspected, tested and calibrated independently.
 */
