...
describe('equipment readiness',()=>{
 ...
 const instances:any=[...Array.from({length:2},(_,i)=>({instanceId:`tank-${i+1}`,definitionId:'tank',status:'operational'})),{instanceId:'at-1',definitionId:'at',status:'operational'},{instanceId:'arty-1',definitionId:'arty',status:'operational'}];
 const personnel:any=[];
