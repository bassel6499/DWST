...
| P2-S26 | DWST has no formal public module/API boundary | OPEN — NEXT | Establish a stable DWST entry point/API separating simulation core from ORBAT Mapper internals; UI and future standalone/phone/reporting clients must not depend on deep internal file paths. |
