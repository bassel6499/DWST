...
| P2-S27 | Canonical projection can silently suppress invalid crew-definition data | OPEN — NEXT | Projection must surface invalid/missing crew requirements as explicit validation errors rather than swallowing exceptions and continuing with under-counted readiness. |
